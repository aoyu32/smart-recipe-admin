  ...
  <div class="page-card" style="padding: 24px;">
    <div class="toolbar">
      <div class="toolbar-left">
        <el-input v-model="filters.keyword" placeholder="按食谱名称搜索" clearable style="width: 220px;" @keyup.enter="handleSearch">
          <template #prefix>
            <el-icon><Search /></el-icon>
          </template>
        </el-input>
        <el-select v-model="filters.categoryId" placeholder="食谱分类" clearable style="width: 180px;">
      ...
      <el-table-column label="互动数据" min-width="180">
        <template #default="{ row }">
          <div class="table-meta-inline">
            点赞 {{ row.likesCount || 0 }} / 收藏 {{ row.collectionsCount || 0 }} / 浏览 {{ row.viewsCount || 0 }}
          </div>
        </template>
      </el-table-column>
  ...
  >
    <el-form ref="formRef" :model="form" :rules="rules" label-position="top" class="form-grid">
      ...
      <el-form-item label="蛋白质(g)">
        <el-input-number v-model="form.protein" :min="0" :precision="1" :step="0.5" style="width: 100%;" />
      </el-form-item>
      <el-form-item label="碳水(g)">
        <el-input-number v-model="form.carbs" :min="0" :precision="1" :step="0.5" style="width: 100%;" />
      </el-form-item>
      <el-form-item label="脂肪(g)">
        <el-input-number v-model="form.fat" :min="0" :precision="1" :step="0.5" style="width: 100%;" />
      </el-form-item>
      ...
      <el-form-item label="食谱介绍" class="form-grid-full">
        <el-input v-model="form.description" type="textarea" :rows="4" placeholder="请输入食谱介绍" />
      </el-form-item>
